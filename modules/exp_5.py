 ...
 # making the offload decision of the tasks in the ques
	...
	def task_offload(self, task_and_time):
  	...
  	# making the lst to store the processing_delay_comp_time 
		...
		return trans_que,comp_que , wait_time_comp_processed_or_dropped_lst , wait_time_trans_processed_or_dropped_lst
...
'''
class node_device(mobile_device):
	def __init__(self, mobile_device):
		self.trans_que = mobile_device.trans_que

	def task_printer(self,tras_que):
		print(trans_que)
...
#checking of the class and functions
