 ...
 # making the offload decision of the tasks in the ques
    ...
    def task_offload(self, task_and_time):
      ...
      # making the lst to store the processing_delay_comp_time 
        for i in range(episode):
          ...
          # calualte the load for the comp que
                if len(wait_time_comp_processed_or_dropped_lst) == 0:
                    ...
                    wait_time_comp_processed_or_dropped_lst.append(wait_time_comp_processed_or_dropped)  #l comp
                    processing_delay_comp_time_slots_lst.append(processing_delay_comp_time_slots)
                    #print(processing_delay_comp_time_slots, "processing comp")
                #print(wait_time_comp_processed_or_dropped_lst)
                    ...
                    if processing_delay_comp_time_slots > 0:
                        processing_delay_comp_time_slots_lst.append(processing_delay_comp_time_slots) 
                    else:
                        processing_delay_comp_time_slots_lst.append(0) 

                    wait_time_comp_processed_or_dropped = min(task_and_time[i][0] + processing_delay_comp_time_slots + (task_and_time[i][2])/(2.5*0.1)/0.297, task_and_time[i][0] + 10 -1)  # eq 6
            ...
            #do the append logic in for the comp que
                ...
                if len(wait_time_trans_processed_or_dropped_lst)==0:
                    ...
                    #print(processing_delay_trans_time_slots,"now")
                else:
                    ...
                    if processing_delay_trans_time_slots > 0 :
                        processing_delay_trans_time_slots_lst.append(processing_delay_trans_time_slots)
                    else:
                        processing_delay_trans_time_slots_lst.append(0)
                    wait_time_trans_processed_or_dropped = min( task_and_time[i][0] + processing_delay_trans_time_slots + (task_and_time[i][2])/(14*0.1) -1 , task_and_time[i][0] + 10 - 1 )
                    wait_time_trans_processed_or_dropped_lst.append(wait_time_trans_processed_or_dropped)
        ...
        #print(trans_que)
        #print(comp_que)
        print("The trans_que_with_offload_var")
        ...
        print(comp_que)
        print("End")
        print("processing delay in comp time slots")
        print(processing_delay_comp_time_slots_lst)
        print("End")
        print("processing delay in trans time slots")
        print(processing_delay_trans_time_slots_lst)
        print("End")
        print("wait time in comp que")
        print(wait_time_comp_processed_or_dropped_lst)
        print("End")
        print("wait time in trans que lst")
        print(wait_time_trans_processed_or_dropped_lst)
        print("End")
